...
function setheight(the_height){
    localStorage.setItem("savedHeight",the_height);
}
function round2(num) {
...
function myFunction(the_height) {
    ...
    if(localStorage.getItem('height') != null){
        localStorage.setItem('height',localStorage.getItem('height')+"@"+`{ "Date":"${currentDate}","Weight":${the_weight},"Height":${the_height}}`);
    }else
    localStorage.setItem('height',`{ "Date":"${currentDate}","Weight":${the_weight},"Height":${the_height}}`);  
} 
